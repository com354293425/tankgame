...
public class Sharing1 extends Applet{
	...
	private int numObsevers = 0;
	public void init() {
		if(isApplet) {
			numCounters = Integer.parseInt(getParameter("size"));
			numObsevers = Integer.parseInt(getParameter("observers"));
		}
	...
	public static void main(String[] args) {
		...
		applet.numObsevers = (args.length < 2 ? 5 : Integer.parseInt(args[1]));
